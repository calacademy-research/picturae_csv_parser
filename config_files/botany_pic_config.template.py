...
NFN_COL_DICT = {
            ...
            'Herbarium Code': 'herbarium_code',
            'Accession Number': 'AltCatalogNumber', # accession number
            'Habitat': 'Remarks',  # Habitat
            'Plant Description': 'Text1',  # specimen description
            'Elevation - Minimum': 'MinElevation',
            'Elevation - Maximum': 'MaxElevation',
            'Elevation Units': 'OriginalElevationUnit',
            'Are there geographic coordinates present?_1': "coordinates_present_1",
            'Township_1': 'Township_1',
            'Range_1': 'Range_1',
            'Section_1': 'Section_1',
            'Map Quadrangle_1': 'Quadrangle_1',
            'UTM Zone_1': "Utm_zone_1",
            'UTM Easting_1': "Utm_easting_1",
            'UTM Northing_1': "Utm_northing_1",
            'UTM - Datum_1': "Utm_datum_1",
            'Latitude coordinates - Verbatim_1': 'lat_verbatim_1',
            'Longitude coordinates - Verbatim_1': 'long_verbatim_1',
            'Datum - Latitude, Longitude_1': 'lat_long_datum_1',
            'Is there another set of coordinates that need to be transcribed?_1': "coordinates_present_2",
            'Township_2': 'Township_2',
            'Range_2': 'Range_2',
            'Section_2': 'Section_2',
            'Map Quadrangle_2': 'Quadrangle_2',
            'UTM Zone_2': "Utm_zone_2",
            'UTM Easting_2': "Utm_easting_2",
            'UTM Northing_2': "Utm_northing_2",
            'UTM - Datum_2': "Utm_datum_2",
            'Latitude coordinates - Verbatim_2': 'lat_verbatim_2',
            'Longitude coordinates - Verbatim _2': 'long_verbatim_2',
            'Datum - Latitude, Longitude_2': 'lat_long_datum_2',
            'Is there another set of coordinates that need to be transcribed?_2': "coordinates_present_3",
            'Township_3': 'Township_3',
            'Range_3': 'Range_3',
            'Section_3': 'Section_3',
            'Map Quadrangle_3': 'Quadrangle_3',
            'UTM Zone_3': "Utm_zone_3",
            'UTM Easting_3': "Utm_easting_3",
            'UTM Northing_3': "Utm_northing_3",
            'UTM - Datum_3': "Utm_datum_3",
            'Latitude coordinates - Verbatim_3': 'lat_verbatim_3',
            'Longitude coordinates - Verbatim_3': 'long_verbatim_3',
            'Datum - Latitude, Longitude_3': 'lat_long_datum_3'
        }
